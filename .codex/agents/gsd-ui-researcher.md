...
Use template from `F:/VisualStudio/CattleFarm/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.codex/get-shit-done/templates/UI-SPEC.md`
