...
<required_reading>
@F:/VisualStudio/CattleFarm/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@F:/VisualStudio/CattleFarm/.codex/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/VisualStudio/CattleFarm/.codex
                  → checks F:/VisualStudio/CattleFarm/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/VisualStudio/CattleFarm/.codex/get-shit-done
                  → writes to F:/VisualStudio/CattleFarm/.codex/get-shit-done/hooks/
...
@F:/VisualStudio/CattleFarm/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @F:/VisualStudio/CattleFarm/.codex/get-shit-done/references/common-bug-patterns.md
