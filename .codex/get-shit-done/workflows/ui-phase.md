...
```markdown
Read F:/VisualStudio/CattleFarm/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.codex/agents/gsd-ui-checker.md for instructions.
