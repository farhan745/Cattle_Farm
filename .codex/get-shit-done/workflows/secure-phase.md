...
```
Agent(
  prompt="Read F:/VisualStudio/CattleFarm/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/VisualStudio/CattleFarm/.codex/get-shit-done/templates/SECURITY.md`
