...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.windsurf/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.windsurf/.gsd-profile`) and re-stages the active skills directory in place.
...
(`~/.claude`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.windsurf/skills`).
...
(i.e. `F:/VisualStudio/CattleFarm/.windsurf/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.windsurf/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.windsurf/.gsd-profile`
Skill dirs: `~/.windsurf/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
