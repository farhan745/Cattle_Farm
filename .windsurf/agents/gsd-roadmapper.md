...
Reference full template: `F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/templates/state.md`.
