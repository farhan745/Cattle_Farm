...
Use template from `F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/templates/UI-SPEC.md`
