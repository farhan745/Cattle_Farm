...
```markdown
Read F:/VisualStudio/CattleFarm/.windsurf/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.windsurf/agents/gsd-ui-checker.md for instructions.
