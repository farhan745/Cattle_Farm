...
- Usage: Reference from command with `@F:/VisualStudio/CattleFarm/.windsurf/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to F:/VisualStudio/CattleFarm/.windsurf/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to F:/VisualStudio/CattleFarm/.windsurf/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
