...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.trae/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.trae/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/VisualStudio/CattleFarm/.trae/skills/gsd-*/`.
...
(`F:/VisualStudio/CattleFarm/.trae`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.trae/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `F:/VisualStudio/CattleFarm/.trae` as `configDir`. The skill dirs themselves live at
`F:/VisualStudio/CattleFarm/.trae/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Trae — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-F:/VisualStudio/CattleFarm/.trae}"
SCOPE="global"
...
(i.e. `F:/VisualStudio/CattleFarm/.trae/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.trae/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.trae/.gsd-profile`
Skill dirs: `F:/VisualStudio/CattleFarm/.trae/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.trae/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.trae/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
