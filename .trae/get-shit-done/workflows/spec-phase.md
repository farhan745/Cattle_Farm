...
```bash
INIT=$(node "F:/VisualStudio/CattleFarm/.trae/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @F:/VisualStudio/CattleFarm/.trae/get-shit-done/templates/spec.md.
