...
```markdown
Read F:/VisualStudio/CattleFarm/.trae/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.trae/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.trae/agents/gsd-ui-checker.md for instructions.
