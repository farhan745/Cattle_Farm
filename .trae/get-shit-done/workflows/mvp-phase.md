...
<required_reading>
@F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/user-story-template.md
@F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/spidr-splitting.md
@F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/spidr-splitting.md`. Briefly:
