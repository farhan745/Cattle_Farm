...
INSTALL_JS_GLOBAL="F:/VisualStudio/CattleFarm/.trae/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node F:/VisualStudio/CattleFarm/.trae/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
