...
Key references:
- @F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/ui-brand.md (display patterns)
- @F:/VisualStudio/CattleFarm/.trae/agents/gsd-user-profiler.md (profiler agent definition)
- @F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="F:/VisualStudio/CattleFarm/.trae/get-shit-done/USER-PROFILE.md"
...
```bash
cp "F:/VisualStudio/CattleFarm/.trae/get-shit-done/USER-PROFILE.md" "F:/VisualStudio/CattleFarm/.trae/USER-PROFILE.backup.md"
```
...
✓ Stores profile at F:/VisualStudio/CattleFarm/.trae/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/user-profiling.md`
...
Reference: @F:/VisualStudio/CattleFarm/.trae/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to F:/VisualStudio/CattleFarm/.trae/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .trae/rules/" -- "Add profile to F:/VisualStudio/CattleFarm/.trae/.trae/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at F:/VisualStudio/CattleFarm/.trae/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at F:/VisualStudio/CattleFarm/.trae/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to F:/VisualStudio/CattleFarm/.trae/.trae/rules/"
...
```bash
BACKUP_PATH="F:/VisualStudio/CattleFarm/.trae/USER-PROFILE.backup.md"
```
...
Your profile:    F:/VisualStudio/CattleFarm/.trae/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   F:/VisualStudio/CattleFarm/.trae/skills/gsd-dev-preferences/SKILL.md
  ✓ .trae/rules/ section       .trae/rules/
  ✓ Global .trae/rules/        F:/VisualStudio/CattleFarm/.trae/.trae/rules/
```
