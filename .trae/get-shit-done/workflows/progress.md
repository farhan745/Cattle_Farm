...
> for project name, milestone, current phase, and next-step routing. .trae/rules/ ## Project
> blocks are a secondary config aid that may be significantly stale — do NOT use the
> .trae/rules/ project description as a source for any progress report field.
