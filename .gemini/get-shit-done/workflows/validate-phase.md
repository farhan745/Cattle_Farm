...
```
Agent(
  prompt="Read F:/VisualStudio/CattleFarm/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/VisualStudio/CattleFarm/.gemini/get-shit-done/templates/VALIDATION.md`
