...
```markdown
Read F:/VisualStudio/CattleFarm/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.gemini/agents/gsd-ui-checker.md for instructions.
