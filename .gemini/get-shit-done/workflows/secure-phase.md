...
```
Agent(
  prompt="Read F:/VisualStudio/CattleFarm/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/VisualStudio/CattleFarm/.gemini/get-shit-done/templates/SECURITY.md`
