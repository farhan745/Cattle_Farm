...
Use template from `F:/VisualStudio/CattleFarm/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.gemini/get-shit-done/templates/UI-SPEC.md`
