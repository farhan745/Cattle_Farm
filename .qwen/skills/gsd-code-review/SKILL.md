...
<execution_context>
@F:/VisualStudio/CattleFarm/.qwen/get-shit-done/workflows/code-review.md
</execution_context>
...
Context files (QWEN.md, SUMMARY.md, phase state) are resolved inside the workflow via `gsd-tools query init.phase-op` and delegated to agent via `<files_to_read>` blocks.
</context>
