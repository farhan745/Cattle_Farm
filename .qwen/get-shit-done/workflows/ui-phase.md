...
```markdown
Read F:/VisualStudio/CattleFarm/.qwen/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.qwen/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.qwen/agents/gsd-ui-checker.md for instructions.
