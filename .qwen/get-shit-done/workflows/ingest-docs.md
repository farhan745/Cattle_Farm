...
```bash
INIT=$(node "F:/VisualStudio/CattleFarm/.qwen/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "F:/VisualStudio/CattleFarm/.qwen/get-shit-done/bin/gsd-tools.cjs" commit \
