...
Reference full template: `F:/VisualStudio/CattleFarm/.qwen/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/VisualStudio/CattleFarm/.qwen/get-shit-done/templates/state.md`.
