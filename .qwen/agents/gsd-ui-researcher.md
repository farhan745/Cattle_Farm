...
Use template from `F:/VisualStudio/CattleFarm/.qwen/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.qwen/get-shit-done/templates/UI-SPEC.md`
