...
```markdown
Read F:/VisualStudio/CattleFarm/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/agents/gsd-ui-checker.md for instructions.
