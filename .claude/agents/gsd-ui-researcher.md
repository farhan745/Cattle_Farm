...
Use template from `F:/VisualStudio/CattleFarm/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.claude/get-shit-done/templates/UI-SPEC.md`
