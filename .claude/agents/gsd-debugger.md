...
<required_reading>
@F:/VisualStudio/CattleFarm/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@F:/VisualStudio/CattleFarm/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/VisualStudio/CattleFarm/.claude
                  → checks F:/VisualStudio/CattleFarm/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/VisualStudio/CattleFarm/.claude/get-shit-done
                  → writes to F:/VisualStudio/CattleFarm/.claude/get-shit-done/hooks/
...
@F:/VisualStudio/CattleFarm/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @F:/VisualStudio/CattleFarm/.claude/get-shit-done/references/common-bug-patterns.md
