...
```bash
INIT=$(node "F:/VisualStudio/CattleFarm/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @F:/VisualStudio/CattleFarm/.claude/get-shit-done/templates/spec.md.
