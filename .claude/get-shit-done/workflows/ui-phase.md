...
```markdown
Read F:/VisualStudio/CattleFarm/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.claude/agents/gsd-ui-checker.md for instructions.
