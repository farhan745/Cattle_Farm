...
```bash
INIT=$(node "F:/VisualStudio/CattleFarm/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "F:/VisualStudio/CattleFarm/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
