...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.claude/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/VisualStudio/CattleFarm/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.claude/skills`).
...
`F:/VisualStudio/CattleFarm/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `F:/VisualStudio/CattleFarm/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.claude/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.claude/.gsd-profile`
Skill dirs: `F:/VisualStudio/CattleFarm/.claude/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
