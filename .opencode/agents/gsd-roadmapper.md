...
Reference full template: `F:/VisualStudio/CattleFarm/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/VisualStudio/CattleFarm/.opencode/get-shit-done/templates/state.md`.
