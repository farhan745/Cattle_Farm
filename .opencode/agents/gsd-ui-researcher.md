...
Use template from `F:/VisualStudio/CattleFarm/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.opencode/get-shit-done/templates/UI-SPEC.md`
