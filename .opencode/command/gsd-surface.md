...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.opencode/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/VisualStudio/CattleFarm/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.opencode/skills`).
...
`F:/VisualStudio/CattleFarm/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `F:/VisualStudio/CattleFarm/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.opencode/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.opencode/.gsd-profile`
Skill dirs: `F:/VisualStudio/CattleFarm/.opencode/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
