...
```markdown
Read F:/VisualStudio/CattleFarm/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.opencode/agents/gsd-ui-checker.md for instructions.
