...
```
Agent(
  prompt="Read F:/VisualStudio/CattleFarm/.codebuddy/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/templates/VALIDATION.md`
