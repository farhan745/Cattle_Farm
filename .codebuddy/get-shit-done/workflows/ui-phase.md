...
```markdown
Read F:/VisualStudio/CattleFarm/.codebuddy/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.codebuddy/agents/gsd-ui-checker.md for instructions.
