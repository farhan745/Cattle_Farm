...
<required_reading>
@F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/VisualStudio/CattleFarm/.codebuddy
                  → checks F:/VisualStudio/CattleFarm/.codebuddy/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done
                  → writes to F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/hooks/
...
@F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/references/thinking-models-debug.md
...
- Read @F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/references/common-bug-patterns.md
