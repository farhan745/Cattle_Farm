...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.codebuddy/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.codebuddy/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/VisualStudio/CattleFarm/.codebuddy/skills/gsd-*/`.
...
(`F:/VisualStudio/CattleFarm/.codebuddy`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.codebuddy/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `F:/VisualStudio/CattleFarm/.codebuddy` as `configDir`. The skill dirs themselves live at
`F:/VisualStudio/CattleFarm/.codebuddy/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# CodeBuddy — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-F:/VisualStudio/CattleFarm/.codebuddy}"
SCOPE="global"
...
(i.e. `F:/VisualStudio/CattleFarm/.codebuddy/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.codebuddy/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.codebuddy/.gsd-profile`
Skill dirs: `F:/VisualStudio/CattleFarm/.codebuddy/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.codebuddy/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
