...
Reference full template: `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/templates/state.md`.
