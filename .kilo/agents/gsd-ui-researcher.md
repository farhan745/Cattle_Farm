...
Use template from `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/templates/UI-SPEC.md`
