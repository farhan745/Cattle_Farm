...
<reference>
@F:/VisualStudio/CattleFarm/.kilo/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/references/user-profiling.md` to load:
