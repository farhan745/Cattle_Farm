...
```
Agent(
  prompt="Read F:/VisualStudio/CattleFarm/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/templates/SECURITY.md`
