...
INSTALL_JS_GLOBAL="F:/VisualStudio/CattleFarm/.kilo/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node F:/VisualStudio/CattleFarm/.kilo/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
