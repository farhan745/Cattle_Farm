...
```markdown
Read F:/VisualStudio/CattleFarm/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.kilo/agents/gsd-ui-checker.md for instructions.
