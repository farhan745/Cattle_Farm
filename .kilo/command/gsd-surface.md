...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.kilo/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/VisualStudio/CattleFarm/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.kilo/skills`).
...
`F:/VisualStudio/CattleFarm/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `F:/VisualStudio/CattleFarm/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.kilo/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.kilo/.gsd-profile`
Skill dirs: `F:/VisualStudio/CattleFarm/.kilo/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.kilo/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
