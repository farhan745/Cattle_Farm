...
Use template from `F:/VisualStudio/CattleFarm/.hermes/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.hermes/get-shit-done/templates/UI-SPEC.md`
