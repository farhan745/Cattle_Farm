...
```markdown
Read F:/VisualStudio/CattleFarm/.hermes/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.hermes/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.hermes/agents/gsd-ui-checker.md for instructions.
