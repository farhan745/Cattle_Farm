...
Use template from `F:/VisualStudio/CattleFarm/.augment/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.augment/get-shit-done/templates/UI-SPEC.md`
