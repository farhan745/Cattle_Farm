...
```markdown
Read F:/VisualStudio/CattleFarm/.augment/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.augment/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.augment/agents/gsd-ui-checker.md for instructions.
