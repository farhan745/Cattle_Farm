...
```bash
INIT=$(node "F:/VisualStudio/CattleFarm/.augment/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @F:/VisualStudio/CattleFarm/.augment/get-shit-done/templates/spec.md.
