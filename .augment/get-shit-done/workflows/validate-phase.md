...
```
Agent(
  prompt="Read F:/VisualStudio/CattleFarm/.augment/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/VisualStudio/CattleFarm/.augment/get-shit-done/templates/VALIDATION.md`
