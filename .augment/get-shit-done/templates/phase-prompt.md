...
<!-- For checkpoint task examples and patterns, see @F:/VisualStudio/CattleFarm/.augment/get-shit-done/references/checkpoints.md -->
...
See `F:/VisualStudio/CattleFarm/.augment/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `F:/VisualStudio/CattleFarm/.augment/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `F:/VisualStudio/CattleFarm/.augment/get-shit-done/workflows/verify-phase.md` for verification logic.
