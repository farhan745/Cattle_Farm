...
Reference full template: `F:/VisualStudio/CattleFarm/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/VisualStudio/CattleFarm/.cursor/get-shit-done/templates/state.md`.
