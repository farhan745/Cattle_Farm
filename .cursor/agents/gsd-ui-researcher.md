...
Use template from `F:/VisualStudio/CattleFarm/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/VisualStudio/CattleFarm/.cursor/get-shit-done/templates/UI-SPEC.md`
