...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/VisualStudio/CattleFarm/.cursor/.gsd-surface.json`
(sibling to `F:/VisualStudio/CattleFarm/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/VisualStudio/CattleFarm/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`F:/VisualStudio/CattleFarm/.cursor/skills`).
...
`F:/VisualStudio/CattleFarm/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `F:/VisualStudio/CattleFarm/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/VisualStudio/CattleFarm/.cursor/.gsd-surface.json`
Install profile marker: `F:/VisualStudio/CattleFarm/.cursor/.gsd-profile`
Skill dirs: `F:/VisualStudio/CattleFarm/.cursor/skills/gsd-*/`
Engine module: `F:/VisualStudio/CattleFarm/.cursor/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/VisualStudio/CattleFarm/.cursor/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
