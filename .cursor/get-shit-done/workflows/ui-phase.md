...
```markdown
Read F:/VisualStudio/CattleFarm/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/VisualStudio/CattleFarm/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/VisualStudio/CattleFarm/.cursor/agents/gsd-ui-checker.md for instructions.
