...
<reference>
@F:/VisualStudio/CattleFarm/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `F:/VisualStudio/CattleFarm/get-shit-done/references/user-profiling.md` to load:
