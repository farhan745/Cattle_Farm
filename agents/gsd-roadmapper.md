...
Reference full template: `F:/VisualStudio/CattleFarm/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/VisualStudio/CattleFarm/get-shit-done/templates/state.md`.
